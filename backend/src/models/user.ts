...
import { IPendingUser, IUser } from "../types/model.js";
...
const actualUserSchema = new Schema({
  ...
  role: { type: String, enum: ['supplier', 'buyer', 'auditor','user'],default: "user" },
...
export const User = mongoose.model<IUser>("User", actualUserSchema);
